...
public class PaymentService {
    ...
    public String createStripeCheckoutSession(Cart cart) throws StripeException {
        ...
        SessionCreateParams params = SessionCreateParams.builder()
                ...
                .addLineItem(
                        SessionCreateParams.LineItem.builder()
                                ...
                                // Set price data with product_data (creating product dynamically)
        ...
        // Call GuestOrderService to create a pending GuestOrder
